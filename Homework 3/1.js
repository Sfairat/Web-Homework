...
function farengheit(degree) {
    return (9 / 5) * degree + 32;
}

const celseus = Number.parseFloat(prompt("Введите температуру в градусах Цельсия: "));
alert(`${celseus} по Цельсию равно ${(Math.round(farengheit(celseus) * 100)) / 100} по Фаренгейту.`);